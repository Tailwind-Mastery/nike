        ...
        <div className="2xl:container 2xl:mx-auto">
            <div className="flex flex-col gap-10 lg:px-10 px-5 py-4 border-t">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <Link to={'/menu/newArrivals'} className="flex items-center gap-10 justify-between">
                    ...
                    <Link to={'/menu/men'} className="flex items-center gap-10 justify-between">
                        <h3 className="text-xl">
                            Men
                        </h3>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <Link to={'/menu/women'} className="flex items-center gap-10 justify-between">
                        <h3 className="text-xl">
                            Women
                        </h3>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <Link to={'/menu/kids'} className="flex items-center gap-10 justify-between">
                        <h3 className="text-xl">
                            Kids
                        </h3>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <Link to={'/menu/accesories'} className="flex items-center gap-10 justify-between">
                        <h3 className="text-xl">
                            Accessories
                        </h3>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <Link to={'/menu/sale'} className="flex items-center gap-10 justify-between">
                        <h3 className="text-xl">
                            Sale
                        </h3>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
